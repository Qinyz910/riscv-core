...
SOURCES = [
    ROOT / "rtl" / "core" / "common" / "rv32i_core_pkg.sv",
    ROOT / "rtl" / "core" / "decode" / "rv32i_decoder.sv",
    ROOT / "tb" / "src" / "rv32i_decoder_tb.sv",
]


def run_decoder_simulation():
    ...
    with tempfile.TemporaryDirectory() as build_dir:
        ...
        image_path = build_path / "decoder_tb.vvp"
